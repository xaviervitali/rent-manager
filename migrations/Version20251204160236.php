 ...
 */
final class Version20251204160236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE charge_type (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, is_recoverable TINYINT(1) NOT NULL, is_rent_component TINYINT(1) NOT NULL, comment LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE imputation (id INT AUTO_INCREMENT NOT NULL, amount NUMERIC(10, 2) NOT NULL, period_start DATE NOT NULL, period_end DATE NOT NULL, invoice_file VARCHAR(255) DEFAULT NULL, note LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, housing_id INT NOT NULL, type_id INT NOT NULL, INDEX IDX_AE81A25AAD5873E3 (housing_id), INDEX IDX_AE81A25AC54C8C93 (type_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
